...
CREATE TABLE `composiciones` (
  ...
  PRIMARY KEY (`codigo`,`component`),
  KEY `codigo_idx` (`codigo`),
  KEY `composicion_idx` (`component`),
  ...
  CONSTRAINT `component` FOREIGN KEY (`component`) REFERENCES `componentes` (`component`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2013-01-05 20:13:29
